...
- Patched vitest npm package vulnerabilities.
- Patched load-tester base image to address vulnerabilities.

## [4.2.5] - 2026-09-09

### Security

- Patched the fast-uri npm, @humanfs/node, and js-yaml npm package vulnerabilities.
- Patched the web-console image to address vulnerabilities.
