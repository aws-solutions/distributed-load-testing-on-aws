...
export class ScenarioTestRunnerStorageConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: ScenarioTestRunnerStorageConstructProps) {
    ...
    let historyDDBActions = ['dynamodb:BatchWriteItem', 'dynamodb:PutItem', 'dynamodb:Query'];
    ...
    const scenariosDDBActions = ['dynamodb:DeleteItem', 'dynamodb:GetItem', 'dynamodb:PutItem', 'dynamodb:Scan', 'dynamodb:UpdateItem'];
