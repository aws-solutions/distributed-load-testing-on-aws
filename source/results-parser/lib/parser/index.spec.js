...
describe('#RESULTS PARSER::', () => {
  ...
  const testScenario = "{\"execution\":[{\"ramp-up\":\"10s\",\"hold-for\":\"2m\",\"scenario\":\"test1-5-err\"}],\"scenarios\":{\"test1-5-err\":{\"script\":\"ryWOD3EDT.jmx\"}},\"reporting\":[{\"module\":\"final-stats\",\"summary\":true,\"percentiles\":true,\"summary-labels\":true,\"test-duration\":true,\"dump-xml\":\"/tmp/artifacts/results.xml\"}]}";
  ...
  const updateTableParams = { testId, finalResults: finalAggregatedResults, startTime, endTime, testTaskConfigs, testScenario, testDescription, testType, region, ecsCloudWatchLogGroup, taskCluster };
  const widgetMetricsRegion1 = [
    ["distributed-load-testing", `${testId}-avgRt`, { "region": "us-east-1", "color": "#FF9900", "label": "Avg Response Time" }],
    ["distributed-load-testing", `${testId}-numVu`, { "region": "us-east-1", "color": "#1f77b4", "label": "Virtual Users", "stat": "Sum", "yAxis": "right" }],
    ["distributed-load-testing", `${testId}-numSucc`, { "region": "us-east-1", "color": "#2CA02C", "label": "Successes", "stat": "Sum", "yAxis": "right" }],
    ["distributed-load-testing", `${testId}-numFail`, { "region": "us-east-1", "color": "#D62728", "label": "Failures", "stat": "Sum", "yAxis": "right" }]
  ];
  const widgetMetricsRegion2 = [
    ["distributed-load-testing", `${testId}-avgRt`, { "region": "us-east-2", "color": "#FF9900", "label": "Avg Response Time" }],
    ["distributed-load-testing", `${testId}-numVu`, { "region": "us-east-2", "color": "#1f77b4", "label": "Virtual Users", "stat": "Sum", "yAxis": "right" }],
    ["distributed-load-testing", `${testId}-numSucc`, { "region": "us-east-2", "color": "#2CA02C", "label": "Successes", "stat": "Sum", "yAxis": "right" }],
    ["distributed-load-testing", `${testId}-numFail`, { "region": "us-east-2", "color": "#D62728", "label": "Failures", "stat": "Sum", "yAxis": "right" }]
  ];
  const aggregateWidgetMetrics = [
    ["distributed-load-testing", `${testId}-avgRt`, { "region": "us-east-1", "color": "#FF9900", "label": "Avg Response Time", id: 'avgRt0', visible: false }],
    ["distributed-load-testing", `${testId}-numVu`, { "region": "us-east-1", "color": "#1f77b4", "label": "Virtual Users", "stat": "Sum", "yAxis": "right", id: 'numVu0', visible: false }],
    ["distributed-load-testing", `${testId}-numSucc`, { "region": "us-east-1", "color": "#2CA02C", "label": "Successes", "stat": "Sum", "yAxis": "right", id: 'numSucc0', visible: false }],
    ["distributed-load-testing", `${testId}-numFail`, { "region": "us-east-1", "color": "#D62728", "label": "Failures", "stat": "Sum", "yAxis": "right", id: 'numFail0', visible: false }],
    ["distributed-load-testing", `${testId}-avgRt`, { "region": "us-east-2", "color": "#FF9900", "label": "Avg Response Time", id: 'avgRt1', visible: false }],
    ["distributed-load-testing", `${testId}-numVu`, { "region": "us-east-2", "color": "#1f77b4", "label": "Virtual Users", "stat": "Sum", "yAxis": "right", id: 'numVu1', visible: false }],
    ["distributed-load-testing", `${testId}-numSucc`, { "region": "us-east-2", "color": "#2CA02C", "label": "Successes", "stat": "Sum", "yAxis": "right", id: 'numSucc1', visible: false }],
    ["distributed-load-testing", `${testId}-numFail`, { "region": "us-east-2", "color": "#D62728", "label": "Failures", "stat": "Sum", "yAxis": "right", id: 'numFail1', visible: false }],
  ...
  it('should save image and return key and metric on createWidget success', async () => {
    ...
    const expectedImageLocation = `cloudwatch-images/${testId}/CloudWatchMetrics-${region}-${new Date(startTime).toISOString()}`;
  ...
  it('should save image and return key and metrics for totals on createWidget success', async () => {
    ...
    const result = await lambda.createWidget(startTime, endTime, 'total', testId, widgetMetricsRegion1.concat(widgetMetricsRegion2));
    const expectedImageLocation = `cloudwatch-images/${testId}/CloudWatchMetrics-total-${new Date(startTime).toISOString()}`;
    expect(mockS3).toHaveBeenCalledWith({
      Body: Buffer.from('Image').toString('base64'),
      Bucket: 'scenario_bucket',
