...
export const CreateSimpleScheduleSchema = BaseScenarioSchema.extend({
...
export type CreateSimpleScheduleParameters = z.infer<typeof CreateSimpleScheduleSchema>;

export async function handleCreateSimpleSchedule(
  httpClient: IHttpClient,
  apiEndpoint: string,
  event: AgentCoreEvent
): Promise<unknown> {
  const params = parseEventWithSchema(CreateSimpleScheduleSchema, event);
