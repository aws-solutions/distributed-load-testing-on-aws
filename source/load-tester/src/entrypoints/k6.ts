...
// Container entrypoint for the native k6 image. Bundled by
// deployment/ecr/distributed-load-testing-on-aws-load-tester-k6/pre-build.sh.
...
import { K6Runner } from "../runners/k6.js";

const SERVICE_NAME = "dlt-load-tester-k6";

let logger = createLogger({ serviceName: SERVICE_NAME }).child({ framework: "k6" });
