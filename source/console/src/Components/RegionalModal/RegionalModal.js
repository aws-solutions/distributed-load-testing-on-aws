  ...
  render() {
    return (
      <Modal size="lg" isOpen={this.props.regionalModal} toggle={this.props.toggleRegionalModal}>
        <ModalHeader toggle={this.props.toggleRegionalModal}>
          Manage Regions
        </ModalHeader>
        <ModalBody>
          <Row className="available-regions-title">
            Available Regions
          </Row>
          ...
          <ListGroup horizontal className="available-regions-list">
            {
              this.state.availableRegions.map((region) => (
                <ListGroupItem key={region} className="available-region-item">
          ...
          <Row className="regional-stack-row" fluid="true" >
            <Col>
              ...
              <ul>
                <li>Copy the link for the regional CloudFormation template&nbsp;&nbsp;
                  <Button id="cfTemplateUrl" className="regional-stack-button" color="link" onClick={() => this.handleCopyClick()} ><i className="icon-small bi bi-clipboard-check-fill" ></i></Button>
                  <Tooltip target="cfTemplateUrl" placement="top" trigger="hover" isOpen={this.state.tooltipOpen} toggle={this.toggle} >{this.state.tooltipLanguage}</Tooltip>
                </li>
                <li>Navigate to the <a className="text-link" href="https://console.aws.amazon.com/cloudformation" target="_blank" rel="noreferrer">CloudFormation console</a></li>
            ...
            <span>
              ...
              <a className="regional-cf-link" href={this.state.cfUrl} target="_blank" rel="noreferrer">
                {this.state.cfUrl}
              </a>
            </span>
          </Row>
